...
import EditSortableItem from "./EditSortableItem";

const isTouchDevice = window.matchMedia("(pointer: coarse)").matches;

const EditUploadImagesBox = ({
  control,
  name,
  setIsLoadingState,
  setImgForDelete,
  ...
  return (
    <Controller
      ...
      render={({ field }) => {
        ...
        const sortableContextItems = value.map((img) => img.id); // щоб картинки могли сортуватися по ід
...
export default EditUploadImagesBox;
